        ...
        <div className="px-5">
          <div className="text-[10px] mt-2">
            ...
            <address className="text-[#888888]">
              <p>대표자: 최훈학 | 사업자등록번호: 870-88-01143 </p>
              <p>
                통신판매업 신고번호: xxxxxxxx
                <a
                  href="#"
              ...
              <p>개인정보보호 책임자: 김우진 | 주소: 부산 해운대구 우동</p>
          ...
          <div className="mt-3 text-[9px]">
            <p>
              ㈜에스에스지닷컴은 SSG.COM 실시간 항공권 서비스의
              통신판매중개자로서 거래 당사자가 아니며, 입점 판매사가 등록한 상품
              정보 및 거래에 대해 책임을 지지 않습니다.
            </p>
            <p>
              ㈜에스에스지닷컴 사이트의 상품/판매자/쇼핑정보, 컨텐츠, UI 등에
              대한 무단 복제, 전송, 배포, 스크래핑 등의 행위는 저작권법,
              콘텐츠사업 진흥법 등에 의하여 엄격히 금지됩니다.
            </p>
            <p className="mt-1">© SSG.COM Corp. All rights reserved.</p>
          </div>
        </div>
      </div>
    </footer>
